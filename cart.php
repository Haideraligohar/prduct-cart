                                        ...
                                        <div class="col-sm-6">
                                            <div class="product-info-wrapper">
                                                <div class="product-img">
                                                    <img src="public/assets/product-2.png" alt="GCX-S Sit-2-Stand">
                                                </div>
                                                <div class="product-info-content">
                                                    <h4 class="product-name">GCX-S™ Sit-2-Stand</h4>
                                                    <ul class="product-features">
                                                        <li>2 Half Fillers + 1 Turret</li>
                                                        <li>Curved + Linear</li>
                                                        <li>Standard Laminate, Carbon Mesh</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="product-details">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="product-info-wrapper">
                                                <div class="product-img">
                                                    <img src="public/assets/product-3.png" alt="Sightline">
                                                </div>
                                                <div class="product-info-content">
                                                    <h4 class="product-name">Sightline™</h4>
                                                    <ul class="product-features">
                                                        <li>2 Half Fillers + 1 Turret</li>
                                                        <li>Curved + Linear</li>
                                                        <li>Standard Laminate, Carbon Mesh</li>
